...
type AnimationName = "idle" | "salute" | "clapping" | "victory" | string;

type Props = {
  animationName?: AnimationName;
} & GroupProps;

export function Developer({ animationName = "idle", ...props }: Props) {
  ...
  return (
    <group ref={groupRef} {...props} dispose={null}>
      ...
      <skinnedMesh
        ...
        morphTargetDictionary={
          (nodes.Wolf3D_Head as THREE.Mesh).morphTargetDictionary
        }
        morphTargetInfluences={
          (nodes.Wolf3D_Head as THREE.Mesh).morphTargetInfluences
        }
      />
      <skinnedMesh
        name="Wolf3D_Teeth"
        ...
        morphTargetDictionary={
          (nodes.Wolf3D_Teeth as THREE.Mesh).morphTargetDictionary
        }
        morphTargetInfluences={
          (nodes.Wolf3D_Teeth as THREE.Mesh).morphTargetInfluences
        }
      />
    </group>
  );
